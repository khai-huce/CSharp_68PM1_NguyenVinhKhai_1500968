...
namespace QUANLYSV
{
	...
	public partial class LopHoc : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<SinhVien> _SinhVien;
    ...
    partial void OnGhiChuChanged();
		...
		public LopHoc()
		{
			this._SinhVien = new EntitySet<SinhVien>(new Action<SinhVien>(this.attach_SinhVien), new Action<SinhVien>(this.detach_SinhVien));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_SinhVien_LopHoc", Storage="_SinhVien", ThisKey="MaLop", OtherKey="MaLop", DeleteRule="NO ACTION")]
		public EntitySet<SinhVien> SinhVien
		{
			get
			{
				return this._SinhVien;
			}
			set
			{
				this._SinhVien.Assign(value);
			}
		}
		...
		private void attach_SinhVien(SinhVien entity)
		{
			this.SendPropertyChanging();
			entity.LopHoc = this;
		}
		
		private void detach_SinhVien(SinhVien entity)
		{
			this.SendPropertyChanging();
			entity.LopHoc = null;
		}
    ...
    partial void OnMaLopChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_SinhVien_LopHoc", Storage="_LopHoc", ThisKey="MaLop", OtherKey="MaLop", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._LopHoc.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.SinhVien.Remove(this);
					}
					this._LopHoc.Entity = value;
					if ((value != null))
					{
						value.SinhVien.Add(this);
